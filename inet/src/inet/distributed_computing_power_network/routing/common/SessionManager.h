#ifndef INET_DISTRIBUTED_COMPUTING_POWER_NETWORK_ROUTING_COMMON_SESSIONMANAGER_H_
#define INET_DISTRIBUTED_COMPUTING_POWER_NETWORK_ROUTING_COMMON_SESSIONMANAGER_H_
